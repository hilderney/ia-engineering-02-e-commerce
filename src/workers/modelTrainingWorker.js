...
function makeContext(products, users) {
    ...
    return {
        ...
        dimensions: 2 + categories.length + colors.length, // idade + preço + categorias + cores
        // productAvgAgeNorm
    }
}
...
async function trainModel({ users }) {
            ...
            const trainDate = createTrainingData(context);
            console.log('Training data created:', trainDate);
